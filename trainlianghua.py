...
def main(args):
    ...
    if os.path.exists(args.weights):
        ...
        if 'cfg' in weights_dict.keys():
            model = create_model(num_classes=args.num_classes,kernel_cnf=weights_dict['cfg']).to(device)
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model.state_dict(), "./weights/model-jianzhi-lianghua-{}.pth".format(epoch))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default=r'weights/model-jianzhi-0.pth',
